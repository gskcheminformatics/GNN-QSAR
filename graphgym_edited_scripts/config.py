...
def set_cfg(cfg):
    ...
    # ----------------------------------------------------------------------- #
    # Extra GNN options added
    # ----------------------------------------------------------------------- #
    cfg.gnn.dropout_gat = 0.0
    cfg.gnn.concat_gat = True
    cfg.gnn.negative_slope_gat = 0.2
    cfg.gnn.dim_spline = 1
    cfg.gnn.kernel_size_spline = 2
    cfg.gnn.skip_linear_generalconv = False
    cfg.gnn.att_generalconv = False
    cfg.gnn.attention_type = 'additive'
    cfg.gnn.improved = False
    cfg.gnn.add_self_loops = True
    cfg.gnn.normalize = True
    cfg.gnn.root_weight = True
    cfg.gnn.project = False
    cfg.gnn.fill_value = 'mean'
    cfg.gnn.eps = 0.0
    cfg.gnn.train_eps = False
    cfg.gnn.degree_spline = 1
    cfg.gnn.is_open_spline = True
    cfg.gnn.in_edge_channels = None
